...
describe("Heroes home page tests", function () {
    ...
    it("should have 11 recent badges", async function () {
        ...
        // await PageFactory.getPage("Login").wait(1); // for FireFox
        // await PageFactory.getPage("Login").clickSignIn(); // for FireFox
        ...
        // await PageFactory.getPage("MicrosoftLogin").clickYes(); // for FireFox
        ...
        const firstBadgeOfappreciationBadge = await PageFactory.getPage("MyProfile").appriciationsSection.collection.get(0); // for Chrome
        await hover(firstBadgeOfappreciationBadge); // for Chrome
        await PageFactory.getPage("MyProfile").wait(3);
